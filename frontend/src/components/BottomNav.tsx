import { Flame, Home, MessageCircle, Radio, UserRound, UsersRound } from "lucide-react";
...
export function BottomNav({ wide = false }: { wide?: boolean }) {
  ...
  const listClassName = wide ? "grid grid-cols-6 gap-1 md:flex md:flex-1 md:flex-col md:gap-2" : "grid grid-cols-6 gap-1";
